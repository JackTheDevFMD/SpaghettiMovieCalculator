...
class SpaghettiLettersMovies:
    def __init__(self, letterslist, baseLetters):
        ...
        self.baseLetters = list(baseLetters)

    def calculateCans(self):

        # Figure out how many cans of spaghetti's it would need to write this script
        for eachLetter in script['script']:
            if eachLetter in self.baseLetters:
                if eachLetter not in self.lettersCounter:
                    self.lettersCounter[eachLetter] = 1
                else:
                    self.lettersCounter[eachLetter] += 1
            else:
                pass
        ...
        print(f"""To write the entire movie script of John Wick (2014) you would need: 
        \n{round(self.finalCanAmount, 0)}\n\nCans of Alphabet Spaghetti!
        """)
